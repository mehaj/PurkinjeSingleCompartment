...
static int _reset;
static char *modelname = "Fast inactivating voltage gated sodium current";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lQ10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _lalpham = 35.0 / exp ( ( _lv + 5.0 ) / ( - 10.0 ) ) ;
   _lbetam = 7.0 / exp ( ( _lv + 65.0 ) / 20.0 ) ;
   taum = 1.0 / ( _lQ10 * ( _lalpham + _lbetam ) ) ;
   minf = _lalpham / ( _lalpham + _lbetam ) ;
   _lalphah = 0.225 / ( 1.0 + exp ( ( _lv + 80.0 ) / 10.0 ) ) ;
   _lbetah = 7.5 / exp ( ( _lv - 3.0 ) / ( - 18.0 ) ) ;
