...
static int _reset;
static char *modelname = "slow inactivating voltage gated potassium current";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lQ10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _lalpham = 8.5 / ( 1.0 + exp ( ( _lv + 17.0 ) / ( - 12.5 ) ) ) ;
   _lbetam = 35.0 / ( 1.0 + exp ( ( _lv + 99.0 ) / 14.5 ) ) ;
   taum = 1.0 / ( _lQ10 * ( _lalpham + _lbetam ) ) ;
   minf = _lalpham / ( _lalpham + _lbetam ) ;
   _lalphah = 0.0015 / ( 1.0 + exp ( ( _lv + 89.0 ) / 8.0 ) ) ;
   _lbetah = 0.0055 / ( 1.0 + exp ( ( _lv + 83.0 ) / ( - 8.0 ) ) ) ;
