...
static int _reset;
static char *modelname = "Transient calcium current";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lQ10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _lalpham = 2.6 / ( 1.0 + exp ( ( _lv + 21.0 ) / ( - 8.0 ) ) ) ;
   _lbetam = 0.18 / ( 1.0 + exp ( ( _lv + 40.0 ) / 4.0 ) ) ;
   taum = 1.0 / ( _lQ10 * ( _lalpham + _lbetam ) ) ;
   minf = _lalpham / ( _lalpham + _lbetam ) ;
   _lalphah = 0.0025 / ( 1.0 + exp ( ( _lv + 40.0 ) / 8.0 ) ) ;
   _lbetah = 0.19 / ( 1.0 + exp ( ( _lv + 50.0 ) / ( - 10.0 ) ) ) ;
